...
# 📖 [Loeaderboard] <a name="about-project"></a>

**[Leaderboard]** is a project that aims to integrate promises and callback and async functions in the calling in the hitting of an api.
